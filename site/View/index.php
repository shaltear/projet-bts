                                ...
                                <div class="row portfolio-grid mt-3">
                                    ...
                                    <div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 col-12">
                                        <figure class="effect-text-in">
                                            <img src="../image/equipe/Alexis.jpg" alt="image" />
                                            <figcaption >
                                                <h4 class="text-dark">Alexis</h4>
                                                <p style="background-color: #800000">Devoloppeur back-end, front-end, middle-end <br>Depuis 2023 à lecoinjapon <br>
                                                    Conctat : alexispiget@yahoo.fr</p>
                                            </figcaption>
                                        </figure>
                                    </div>
                                    ...
                                    <div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 col-12">
                                        <figure class="effect-text-in">
                                            <img src="../image/equipe/joel.jpg" alt="image" />
                                            <figcaption >
                                                <h4 class="text-dark">Joel</h4>
                                                <p style="background-color: #800000">Devoloppeur back-end, front-end, middle-end <br>Depuis 2023 à lecoinjapon <br>
                                                    Conctat : joelndjate@gmail.com</p>
                                            </figcaption>
                                        </figure>
                                    </div>
